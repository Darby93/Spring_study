...
<html>
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="${pageContext.request.contextPath}/resources/img/favicons/apple-touch-icon.png">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/img/favicons/favicon.ico">
    <link rel="manifest" href="${pageContext.request.contextPath}/resources/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="${pageContext.request.contextPath}/resources/img/favicons/mstile-150x150.png">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="${pageContext.request.contextPath}/resources/lib/prismjs/prism.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/lib/loaders.css/loaders.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Raleway:100,300,400,500,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/lib/remodal/remodal.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/lib/remodal/remodal-default-theme.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/lib/owl.carousel/owl.carousel.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/lib/lightbox2/css/lightbox.css" rel="stylesheet">
  ...
  <body>
          ...
          <div class="position-relative px-3 w-lg-50 position-lg-absolute" id="baseContent">
            <div class="row align-items-center minh-50vh justify-content-center py-5 minh-lg-100vh">
              <div class="col-8 col-sm-6 text-center">
                <a href="index.html">
                  <img class="mb-5 img-fluid" src="${pageContext.request.contextPath}/resources/img/logo.png" alt="">
                </a>
          ...
          <div class="position-relative w-lg-50 position-lg-fixed four-item-two-column" id="gridNav">
            <div class="row h-lg-100vh">
              <div class="col-6 minh-25vh h-lg-50vh sidebar-item-wrapper py-5" data-content="about">
                <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/navigation/about.jpg);">
                </div>
                <!--/.bg-holder-->

                <div class="sidebar-item">
                  <img class="mb-2 mb-lg-3 nav-icon" src="${pageContext.request.contextPath}/resources/img/lineicons/favorites.svg" alt="">
              ...
              <div class="col-6 minh-25vh h-lg-50vh sidebar-item-wrapper py-5" data-content="service">
                <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/navigation/service.jpg);">
                </div>
                <!--/.bg-holder-->

                <div class="sidebar-item">
                  <img class="mb-2 mb-lg-3 nav-icon" src="${pageContext.request.contextPath}/resources/img/lineicons/suitcase.svg" alt="">
              ...
              <div class="col-6 minh-25vh h-lg-50vh sidebar-item-wrapper py-5" data-content="portfolio">
                <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/navigation/portfolio.jpg);">
                </div>
                <!--/.bg-holder-->

                <div class="sidebar-item">
                  <img class="mb-2 mb-lg-3 nav-icon" src="${pageContext.request.contextPath}/resources/img/lineicons/heart.svg" alt="">
              ...
              <div class="col-6 minh-25vh h-lg-50vh sidebar-item-wrapper py-5" data-content="contact">
                <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/navigation/contact.jpg);">
                </div>
                <!--/.bg-holder-->

                <div class="sidebar-item">
                  <img class="mb-2 mb-lg-3 nav-icon" src="${pageContext.request.contextPath}/resources/img/lineicons/placeholder.svg" alt="">
        ...
        <div class="row no-gutters minh-100vh">
          <div class="col-lg-9 order-1 order-lg-0 page-content pt-6 pt-lg-0">
                  ...
                  <div class="col-lg-10">
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-4 mb-md-0">
                        <div class="bg-holder position-relative rounded py-8 py-md-0" style="background-image:url(${pageContext.request.contextPath}/resources/img/infinity.jpg);">
                        </div>
                        <!--/.bg-holder-->
                      ...
                      <div class="col-md-6 pl-3 pl-md-4">
                        ...
                        <p class="column-xxl-2 mb-0">Boots4 was founded by ThemeWagon Team in 1896. It was called the world's first bootstrap four template, and started as a Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsam illo, magni aut recusandae perspiciatis quam
                  ...
                  <div class="col-lg-10">
                    <div class="card-deck">
                      <div class="card border-2x border-warning rounded py-5 px-3 text-center">
                        <img class="position-absolute r-0 t-0" src="${pageContext.request.contextPath}/resources/img/shapes/1.png" alt="" style="width: 30%; border-top-right-radius: 1px;" />
                        <img class="mx-auto" src="${pageContext.request.contextPath}/resources/img/icons/lightbulb_idea.svg" width="70" alt="" /><span class="d-block fs-3 mt-2 text-dark" data-countup="64973">0</span>
                        <h5>Lines Of Code</h5>
                      </div>
                      <div class="card border-2x border-danger rounded py-5 px-3 text-center">
                        <img class="position-absolute b-0 r-0" src="${pageContext.request.contextPath}/resources/img/shapes/2.png" alt="" style="width: 70%; border-bottom-right-radius: 1px;" />
                        <img class="mx-auto" src="${pageContext.request.contextPath}/resources/img/icons/coffe.svg" width="70" alt="" /><span class="d-block fs-3 mt-2 text-dark" data-countup="10218">0</span>
                        <h5>Cups of Coffee</h5>
                      </div>
                      <div class="card border-2x border-primary rounded py-5 px-3 text-center">
                        <img class="position-absolute t-0 l-0" src="${pageContext.request.contextPath}/resources/img/shapes/3.png" alt="" style="width: 70%;" />
                        <img class="mx-auto" src="${pageContext.request.contextPath}/resources/img/icons/cloud.svg" width="70" alt="" /><span class="d-block fs-3 mt-2 text-dark" data-countup="7499">0</span>
                        <h5>Download</h5>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-10 col-xxl-7 col-xl-9">
                    ...
                    <div class="row">
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/1.jpg" width="140" alt="" />
                        <h5 class="mt-3 mb-1">Alex Butler</h5>
                        <h5 class="text-500 mb-1">Fraud Manager</h5>
                      </div>
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/2.jpg" width="140" alt="" />
                        <h5 class="mt-3 mb-1">Andreas Heim</h5>
                        <h5 class="text-500 mb-1">Software Engineer</h5>
                      </div>
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/3.jpg" width="140" alt="" />
                        <h5 class="mt-3 mb-1">Amanda Alleson</h5>
                        <h5 class="text-500 mb-1">UX Designer</h5>
                      </div>
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/4.jpg" width="140" alt="" />
                        <h5 class="mt-3 mb-1">Brandon Renfrow</h5>
                        <h5 class="text-500 mb-1">Developer</h5>
                      </div>
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/5.jpg" width="140" alt="" />
                        <h5 class="mt-3 mb-1">Brian Childs</h5>
                        <h5 class="text-500 mb-1">Training Manager</h5>
                      </div>
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/6.jpg" width="140" alt="" />
                        <h5 class="mt-3 mb-1">Britney Muller</h5>
                        <h5 class="text-500 mb-1">SEO Scientist</h5>
                      </div>
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/7.jpg" width="140" alt="" />
                        <h5 class="mt-3 mb-1">Casey Coates</h5>
                        <h5 class="text-500 mb-1">Software Engineer</h5>
                      </div>
                      <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3 mb-5">
                        <img class="img-fluid rounded-circle" src="${pageContext.request.contextPath}/resources/img/team/8.jpg" width="140" alt="" />
            ...
            <footer class="page-footer">
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/about.jpg);background-position: 0 27%; transform: scale(1.1);">
              </div>
              <!--/.bg-holder-->
          ...
          <div class="col-lg-3 col-12 t-0 order-0 order-lg-1 position-absolute position-lg-relative">
            <div class="h-lg-100vh sticky-top py-4 sticky-area"><span class="btn-close"><img class="d-none d-lg-block times" src="${pageContext.request.contextPath}/resources/img/times.svg" width="25" alt=""/><img class="d-lg-none" src="${pageContext.request.contextPath}/resources/img/times-black.svg" width="18" alt=""/></span>
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/about.jpg);">
              </div>
              <!--/.bg-holder-->
      ...
      <div class="page position-absolute t-0 w-100" id="service">
        <div class="row no-gutters minh-100vh">
          <div class="col-lg-9 order-1 order-lg-0 page-content pt-6 pt-lg-0">
                  ...
                  <div class="col-lg-10">
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-4 mb-xl-0">
                        <img class="mb-3" src="${pageContext.request.contextPath}/resources/img/icons/cloud.svg" alt="" width="100" />
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-4 mb-xl-0">
                        <img class="mb-3" src="${pageContext.request.contextPath}/resources/img/icons/coffe.svg" alt="" width="100" />
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-4 mb-xl-0">
                        <img class="mb-3" src="${pageContext.request.contextPath}/resources/img/icons/brush.svg" alt="" width="100" />
                  ...
                  <div class="col-md-9 col-xl-8 col-xxl-6 text-center">
                    ...
                    <div class="row align-items-center">
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/1.png" alt="" style="width: 7.5rem;" />
                      </div>
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/2.png" alt="" style="width: 7.5rem;" />
                      </div>
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/3.png" alt="" style="width: 7.5rem;" />
                      </div>
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/4.png" alt="" style="width: 7.5rem;" />
                      </div>
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/5.png" alt="" style="width: 5rem;" />
                      </div>
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/6.png" alt="" style="width: 5rem;" />
                      </div>
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/7.png" alt="" style="width: 5rem;" />
                      </div>
                      <div class="col-4 col-sm-3 col-lg-3 mb-4">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/logo/8.png" alt="" style="width: 4rem;" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <footer class="page-footer">
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/service.jpg);background-position: 0 41%; transform: scale(1.1);">
              </div>
              <!--/.bg-holder-->
          ...
          <div class="col-lg-3 col-12 t-0 order-0 order-lg-1 position-absolute position-lg-relative">
            <div class="h-lg-100vh sticky-top py-4 sticky-area"><span class="btn-close"><img class="d-none d-lg-block times" src="${pageContext.request.contextPath}/resources/img/times.svg" width="25" alt=""/><img class="d-lg-none" src="${pageContext.request.contextPath}/resources/img/times-black.svg" width="18" alt=""/></span>
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/service.jpg);">
              </div>
              <!--/.bg-holder-->
      ...
      <div class="page position-absolute t-0 w-100" id="portfolio">
        <div class="row no-gutters minh-100vh">
          <div class="col-lg-9 order-1 order-lg-0 page-content pt-6 pt-lg-0">
                  ...
                  <div class="col-lg-10">
                    ...
                    <div class="sortable" data-options='{"layoutMode":"packery"}'>
                      ...
                      <div class="row no-gutters sortable-container sortable-container-gutter-fix">
                        <a class="col-6 col-md-4 sortable-item p-2 interior" href="${pageContext.request.contextPath}/resources/img/projects/project-7-f.jpg" data-lightbox="image" data-title="my caption">
                          <img class="w-100 rounded" src="${pageContext.request.contextPath}/resources/img/projects/project-7.jpg" alt="" />
                        </a>
                        <a class="col-6 col-md-4 sortable-item p-2 studio" href="${pageContext.request.contextPath}/resources/img/projects/project-11-f.jpg" data-lightbox="image" data-title="my caption">
                          <img class="w-100 rounded" src="${pageContext.request.contextPath}/resources/img/projects/project-11.jpg" alt="" />
                        </a>
                        <a class="col-6 col-md-4 sortable-item p-2 photography" href="${pageContext.request.contextPath}/resources/img/projects/project-8-f.jpg" data-lightbox="image" data-title="my caption">
                          <img class="w-100 rounded" src="${pageContext.request.contextPath}/resources/img/projects/project-8.jpg" alt="" />
                        </a>
                        <a class="col-6 col-md-4 sortable-item p-2 studio" href="${pageContext.request.contextPath}/resources/img/projects/project-9-f.jpg" data-lightbox="image" data-title="my caption">
                          <img class="w-100 rounded" src="${pageContext.request.contextPath}/resources/img/projects/project-9.jpg" alt="" />
                        </a>
                        <a class="col-6 col-md-4 sortable-item p-2 photography" href="${pageContext.request.contextPath}/resources/img/projects/project-12-f.jpg" data-lightbox="image" data-title="my caption">
                          <img class="w-100 rounded" src="${pageContext.request.contextPath}/resources/img/projects/project-12.jpg" alt="" />
                        </a>
                        <div class="col-6 col-md-4 sortable-item p-2 illustration">
                          <img class="rounded w-100" src="${pageContext.request.contextPath}/resources/img/projects/project-13.jpg" alt="" />
                        ...
                        <div class="col-8 sortable-item p-2" id="owl-slide">
                          <div class="embed-responsive embed-responsive-4by3">
                            <div class="embed-responsive-item owl-carousel owl-theme owl-dots-inner owl-theme-white" data-options='{"items":1,"autoplay":true,"loop":true,"animateOut":"fadeOut"}'>
                              <img class="rounded fit-cover" src="${pageContext.request.contextPath}/resources/img/projects/project-14.jpg" alt="" />
                              <img class="rounded fit-cover" src="${pageContext.request.contextPath}/resources/img/projects/project-15.jpg" alt="" />
                            </div>
                          </div>
                        </div>
                        <a class="col-6 col-md-4 sortable-item p-2 photography" href="${pageContext.request.contextPath}/resources/img/projects/project-10-f.jpg" data-lightbox="image" data-title="my caption">
                          <img class="w-100 rounded" src="${pageContext.request.contextPath}/resources/img/projects/project-10.jpg" alt="" />
                        </a>
                      </div>
                    </div>
                  </div>
            ...
            <footer class="page-footer">
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/portfolio.jpg);background-position: 0 27%; transform: scale(1.1);">
              </div>
              <!--/.bg-holder-->
          ...
          <div class="col-lg-3 col-12 t-0 order-0 order-lg-1 position-absolute position-lg-relative">
            <div class="h-lg-100vh sticky-top py-4 sticky-area"><span class="btn-close"><img class="d-none d-lg-block times" src="${pageContext.request.contextPath}/resources/img/times.svg" width="25" alt=""/><img class="d-lg-none" src="${pageContext.request.contextPath}/resources/img/times-black.svg" width="18" alt=""/></span>
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/portfolio.jpg);">
              </div>
              <!--/.bg-holder-->
      ...
      <div class="page position-absolute t-0 w-100" id="contact">
        <div class="row no-gutters minh-100vh">
          <div class="col-lg-9 order-1 order-lg-0 page-content pt-6 pt-lg-0">
            ...
            <section class="pt-5 pt-xl-7 pt-xxl-8">
              ...
              <div class="container-fluid">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                <div class="row">
                                  ...
                                  <div class="col pl-0">
                                    <a href="mailto:info@themewagon.com">info@slick.com</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                ...
                <div class="row justify-content-center mt-4">
                  <div class="col-lg-10">
                    <div class="rounded googlemap minh-50vh" data-latlng="48.8583701,2.2922873,17" data-scrollwheel="false" data-icon="${pageContext.request.contextPath}/resources/img/map-marker.png" data-zoom="17" data-theme="Default">
            ...
            <footer class="page-footer">
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/contact.jpg);background-position: 0 37%; transform: scale(1.1);">
              </div>
              <!--/.bg-holder-->
          ...
          <div class="col-lg-3 col-12 t-0 order-0 order-lg-1 position-absolute position-lg-relative">
            <div class="h-lg-100vh sticky-top py-4 sticky-area"><span class="btn-close"><img class="d-none d-lg-block times" src="${pageContext.request.contextPath}/resources/img/times.svg" width="25" alt=""/><img class="d-lg-none" src="${pageContext.request.contextPath}/resources/img/times-black.svg" width="18" alt=""/></span>
              <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/img/sidebars/contact.jpg);">
              </div>
              <!--/.bg-holder-->
    ...
    <script src="${pageContext.request.contextPath}/resources/lib/prismjs/prism.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/loaders.css/loaders.css.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/stickyfill.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/remodal/remodal.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/jtap/jquery.tap.js"></script>
    <script src="https://www.google.com/recaptcha/api.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/owl.carousel/owl.carousel.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/isotope-layout/isotope.pkgd.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/isotope-packery/packery-mode.pkgd.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/lightbox2/js/lightbox.js"></script>
